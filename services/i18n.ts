...
const translations = {
  en: {
    ...
    userManagement: {
      ...
      desc: 'Manage all users and their roles.'
    },
    progressModal: {
    ...
    editor: {
      ...
      addWord: 'Add Word',
      trainingContent: 'Challenge Content',
      trainingDesc: 'Key points for challenge mode (words, phrases, or sentences)',
  ...
  zh: {
    ...
    settings: {
      ...
      cloudSync: '云端同步',
      cloudSyncDesc: '在所有桌面客户端之间同步您的训练进度。',
      hardwareAcc: '硬件加速',
      aiProvider: 'AI 服务商切换',
      aiProviderDesc: '选择驱动训练分析的 AI 引擎平台。',
      ...
      playbackSpeed: '朗读语速',
      playbackSpeedDesc: '设置训练模式中卡片语音的默认播放速度。',
      devOptions: '开发者选项',
      showDebug: '显示调试窗口',
    ...
    create: {
      title: '创建新卡包',
      desc: '粘贴您的文本，让 CardEcho AI 将其拆解为易于训练的卡片。',
      generate: '使用 AI 生成卡片',
      cancel: '取消',
      processing: 'AI 正在拆解中...',
      confirm: '确认并添加到库',
    ...
    editor: {
      ...
      addWord: '添加单词',
      trainingContent: '挑战模式内容',
      trainingDesc: '针对挑战模式的考核点（单词、短语或句子）',
