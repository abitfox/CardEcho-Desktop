  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col items-center justify-center p-6">
      <div className="mb-12 flex flex-col items-center">
        ...
        <h1 className="text-3xl font-black text-gray-900 tracking-tight">CardEcho卡读</h1>
        <div className="flex items-center gap-2 mt-2">
           <span className="h-[1px] w-4 bg-gray-200"></span>
           <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em]">AI英语学习卡片复读机</p>
           <span className="h-[1px] w-4 bg-gray-200"></span>
        </div>
      </div>
      ...
      <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl border border-gray-100 p-12 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          {!isLogin && (
            <div>
              <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">姓名</label>
              <input 
                type="text" 
                required 
                value={name}
          ...
          <div>
            <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">邮箱地址</label>
            <input 
              type="email" 
              required 
              value={email}
